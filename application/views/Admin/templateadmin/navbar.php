            ...
            <ul class="notification-menu">
                    ...
                    <ul class="dropdown-menu mailbox dropdown-menu-right">
                        ...
                        <li class="notification-scroll">
                            <div class="message-center">
                                <a href="#">
                                    <div class="user-img">
                                        <img src="<?= base_url('vendors/syntra/Admin/') ?>assets/images/users/avatar-2.jpg" alt="user" class="rounded-circle">
                                ...
                                <a href="#">
                                    <div class="user-img">
                                        <img src="<?= base_url('vendors/syntra/Admin/') ?>assets/images/users/avatar-3.jpg" alt="user" class="rounded-circle">
                                ...
                                <a href="#">
                                    <div class="user-img">
                                        <img src="<?= base_url('vendors/syntra/Admin/') ?>assets/images/users/avatar-4.jpg" alt="user" class="rounded-circle">
                                ...
                                <a href="#">
                                    <div class="user-img">
                                        <img src="<?= base_url('vendors/syntra/Admin/') ?>assets/images/users/avatar-5.jpg" alt="user" class="rounded-circle">
                ...
                <li class="mr-2">
                    <a href="javascript:;" data-toggle="dropdown">
                        <img src="<?= base_url('vendors/syntra/Admin/'); ?>assets/images/users/avatar-1.jpg" alt="">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right profile-menu">
                        <a class="dropdown-item" href="#"><i class="mdi mdi-account-circle m-r-5 text-muted"></i> Profile</a>
                        <a class="dropdown-item" href="#"><span class="badge badge-success pull-right">5</span><i class="mdi mdi-settings m-r-5 text-muted"></i> Settings</a>
                        <a class="dropdown-item" href="#"><i class="mdi mdi-lock-open-outline m-r-5 text-muted"></i> Lock screen</a>
                        <a class="dropdown-item" href="<?= base_url('Home/logout'); ?>" onclick="return confirm('Anda Yakin?');"><i class="mdi mdi-logout m-r-5 text-muted"></i> Logout</a>
                    </div>
